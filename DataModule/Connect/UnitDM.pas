...
//    conn.ExecSQL('INSERT INTO conta(id, email) VALUES(1, ''Jarielton@gmail.com'');');
//    conn.ExecSQL('INSERT INTO conta(id, email) VALUES(2, ''Jarielton@hotmail.com'');');
//    conn.ExecSQL('INSERT INTO char(id, descricao) VALUES(2, ''XXXXX'');');
